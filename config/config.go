...
type BrowserConfig struct {
	...
	XvfbDisplay                   string `env:"XVFB_DISPLAY,default=:99"`
	XvfbEnabled                   bool   `env:"XVFB_ENABLED,default=false"`
	XvfbScreenResolution          string `env:"XVFB_SCREEN_RESOLUTION,default=1920x1080x24"`
}
