...
[![Coverage](https://img.shields.io/codecov/c/github/inference-gateway/browser-agent?label=coverage&logo=codecov)](https://codecov.io/gh/inference-gateway/browser-agent)
...
- `VERSION` - Agent version (default: `0.5.1`)
