...
func main() {
	...
	playwrightDep, err := playwright.NewPlaywrightService(l, &cfg)
	if err != nil {
		l.Fatal("failed to initialize playwright dependency", zap.Error(err))
	}

	// Register navigate_to_url skill
	navigateToURLSkill := skills.NewNavigateToURLSkill(l, playwrightDep)
	...
	clickElementSkill := skills.NewClickElementSkill(l, playwrightDep)
	...
	fillFormSkill := skills.NewFillFormSkill(l, playwrightDep)
	...
	extractDataSkill := skills.NewExtractDataSkill(l, playwrightDep)
	...
	executeScriptSkill := skills.NewExecuteScriptSkill(l, playwrightDep)
	...
	handleAuthenticationSkill := skills.NewHandleAuthenticationSkill(l, playwrightDep)
	...
	waitForConditionSkill := skills.NewWaitForConditionSkill(l, playwrightDep)
