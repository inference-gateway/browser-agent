...
The codebase is generated using ADL CLI 0.27.4 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.27.4 or compatible version for regeneration
