...
The codebase is generated using ADL CLI 0.23.1 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.23.1 or compatible version for regeneration
