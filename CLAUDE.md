...
The codebase is generated using ADL CLI 0.27.6 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.27.6 or compatible version for regeneration
